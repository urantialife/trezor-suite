...
import { NAVBAR_HEIGHT, NAVBAR_HEIGHT_UNIT } from '@suite/config/onboarding/layout';
import { TREZOR_URL, SUPPORT_URL, WIKI_URL, BLOG_URL } from '@suite/config/onboarding/urls';
